...
Get-Content C:\Users\jtack\tex-templates\bibliography-preamble.tex | Add-Content -Path .\tmp\main.md
...
$pandoc_tex_args = @(
    ...
    "--template=/Users/jtack/tex-templates/template.tex",
...
$pandoc_doc_args = @(
    ...
    "--filter=pandoc-citeproc",
    "--metadata-file=metadata.yml",
    "--reference-doc=/Users/jtack/AppData/Roaming/pandoc/custom-reference.docx",
